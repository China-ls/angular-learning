...
> 译文：Angular 介绍
> 
> 原文：[Angular 介绍](https://code.angularjs.org/1.4.3/docs/guide/introduction)

- [ ] 待翻译

# What Is Angular?

AngularJS是用于动态web应用的结构化框架。用HTML作为模板，扩展HTML语法以清晰和简洁地表达应用中的组件。Angular的数据绑定和依赖注入可以减少一些额外的代码。它的所有工作都在浏览器端完成，使它成为与任何服务端技术合作的好伙伴。
